...
!function (n, t) {
    ...
    var En = "mounted", Sn = "move", xn = "moved", _n = "shifted", Cn = "click", Pn = "active", kn = "inactive",
    ...
    var qn = "role", Un = "tabindex", e = "aria-", Kn = e + "controls", Jn = e + "current", Qn = e + "selected",
        ...
        l = e + "live", et = e + "busy", it = e + "atomic", ot = [qn, Un, "disabled", Kn, Jn, Vn, Zn, $n, nt, tt],
        rt = un, ut = un + "__track", st = un + "__list", ct = un + "__slide", at = ct + "--clone",
        ft = ct + "__container", lt = un + "__arrows", dt = un + "__arrow", pt = dt + "--prev", ht = dt + "--next",
        vt = un + "__pagination", gt = vt + "__page", mt = un + "__progress" + "__bar", yt = un + "__toggle",
        bt = un + "__sr", wt = "is-active", Et = "is-prev", St = "is-next", xt = "is-visible", _t = "is-loading",
        Ct = "is-focus-in", Pt = [wt, xt, Et, St, _t, Ct];
    var kt = "touchstart mousedown", Lt = "touchmove mousemove", At = "touchend touchcancel mouseup click";
    var Dt = "slide", Mt = "loop", zt = "fade";
    ...
    function Nt(o, e, t, r) {
        var i, n = Gn(o), u = n.on, s = n.emit, c = n.bind, a = o.Components, f = o.root, l = o.options,
            ...
            m = a.Direction.resolve, y = K(r, "style"), b = K(r, Vn), w = -1 < t, E = A(r, "." + ft),
    ...
    var jt = "keydown";
    var Rt = i + "-lazy", Wt = Rt + "-srcset", Gt = "[" + Rt + "], [" + Wt + "]";
    var Xt = [" ", "Enter"];
    var Bt = Object.freeze({
        __proto__: null, Media: function (i, n, o) {
            ...
            var u, n = Gn(i), t = n.on, c = n.emit, a = i.state.set, r = (n = s.Layout).slideSize, e = n.getPadding,
                f = n.totalSize, l = n.listSize, d = n.sliderSize, p = (n = s.Direction).resolve, h = n.orient,
            ...
            return {
                ...
                exceededLimit: function (n, t) {
                    t = z(t) ? _() : t;
                    var e = !0 !== n && h(t) < h(C(!1)), t = !1 !== n && h(t) > h(C(!0));
                    return e || t
                },
                reposition: m
            }
            ...
            var s, i, c, n = Gn(r).on, a = o.Move, f = a.getPosition, l = a.getLimit, d = a.toPosition, t = o.Slides,
                p = t.isEnough, e = t.getLength, h = r.is(Mt), v = r.is(Dt), g = D(E, !1), m = D(E, !0),
                y = u.start || 0, b = y;
            ...
            function S(n, t, e) {
                ...
                return p() ? (i = _(), (o = function (n) {
                    ...
                    return n
                }(n)) !== n && (t = n, n = o, e = !1), n < 0 || i < n ? n = hn(0, n, t, !0) || hn(i, t, n, !0) ? C(P(n)) : h ? e ? n < 0 ? -(s % c || c) : s : n : u.rewind ? n < 0 ? i : 0 : -1 : e && n !== t && (n = C(P(t) + (n < t ? -1 : 1)))) : n = -1, n
            }
            ...
            return {
                mount: function () {
                    ...
                    return n ? b : y
                }, toIndex: C, toPage: P, toDest: function (n) {
            ...
            var s, t, o, c, a, f, l, d, n = Gn(r), e = n.on, p = n.emit, h = n.bind, v = n.unbind, g = r.state,
                ...
                S = (n = i.Direction).resolve, x = n.orient, _ = m.getPosition, C = m.exceededLimit, P = !1;
            ...
            var i = Gn(n).on, o = t.Elements.track, r = e.live && !e.isNavigation, u = H("span", bt),
                s = Xn(90, D(c, !1));
    ...
    a = function () {
        ...
        return n.mount = function (n, t) {
            ...
            return sn(i.is([1, 7]), "Already mounted!"), i.set(1), this._C = o, this._T = t || this._T || (this.is(zt) ? Yt : qt), this._E = n || this._E, N(T({}, Bt, this._E, {Transition: this._T}), function (n, t) {
                n = n(e, o, e._o);
                (o[t] = n).setup && n.setup()
            }), N(o, function (n) {
                n.mount && n.mount()
